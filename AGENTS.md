...
Crée une branche dédiée pour chaque tâche :
...
agent/refactor/...
agent/experiment/...
Une branche = une mission claire.
Ne mélange pas plusieurs gros sujets dans une seule branche.
Fais des commits courts, explicites et regroupés logiquement.
...
limiter le changement au strict nécessaire ;
